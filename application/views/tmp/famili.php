...
<?php $no=1; foreach ($tmpfamili as $data ) : ?>
						<tr>
							...
							<td class="text-center"><button class="btn btn-info" data-toggle="modal" data-target="#modalfamili<?php echo $data['id'] ?>"><span class="fa fa-search"></span></button></td>					
						</tr>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<a href="<?php echo site_url() ?>/C_CUD/aksiverif/famili/<?php echo $data['id'] ?>" class="btn btn-danger">VERIFIKASI</a>
