		...
		<section class="wrapper site-min-height">
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="row">
						<div class="col-lg-12">
							<h3 class="text-uppercase"><?php echo $ordo['nama_latin'] ?></h3>
							<h4 class="text-uppercase"><?php echo $ordo['nama_umum'] ?></h4>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-12"><h3>KETERANGAN</h3></div>
						<div class="col-lg-12"><p><?php echo $ordo['keterangan']; ?></p></div>
					</div>
					<div class="row">
						<div class="col-lg-12"><h3>CIRI-CIRI</h3></div>
						<div class="col-lg-12"><p><?php echo $ordo['ciri_ciri']; ?></p></div>
					</div>
				</div>
				<div class="col-lg-3">
					<div class="row">
...
<?php if(($level=='bksda')||($level=='lsm')): ?>					
					<div class="row">
						<div class="col-lg-12">
							<div class="tambah">
							<a href="<?php echo site_url() ?>/C_CUD/update/ordo/<?php echo $ordo['id_ordo'] ?>" class="btn btn-success text-uppercase">EDIT DATA ORDO <?php echo $ordo['nama_latin']; ?></a>
							<a href="<?php echo site_url() ?>/C_CUD/create/famili" class="btn btn-success text-uppercase">TAMBAH FAMILI DARI ORDO <?php echo $ordo['nama_latin']; ?> </a>
							</div>
						</div>
					</div>
				</div>
<?php endif; ?>
				<div class="col-lg-12">
					<div class="row">
						<div class="col-lg-12">
							<h4>Berikut Famili-famili didalam <?php echo $ordo['nama_latin']; ?></h4>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-12 table-responsive">
							<table  class="table table-bordered tabeldata	">
								...
								<?php  
									$no=1;
									foreach ($familibyordo as $data): 
								?>
								<tr>
									<td><?php echo $no ?></td>
									<td><?php echo $data['nama_latin']; ?></td>
									<td><?php echo $data['nama_umum']; ?></td>
									<td><button class="btn btn-sm btn-success" data-toggle="modal" data-target="<?php echo '#Modal'.$data['id_ordo']; ?>"><i class="fa fa-search"></i></button>
