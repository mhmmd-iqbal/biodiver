...
<?php $this->load->view('template/sidebar'); ?>
	...
	<section id="main-content">
		<section class="wrapper site-min-height">
			...
			<p>Silahkan input data baru takson class</p>
			<div class="row">
				<div class="col-lg-12">
				...
				<div class="col-lg-12">
					<div class="alert alert-success">
						...
						<div class="row">
							<form class="form-group" action="<?php echo site_url() ?>/C_ImportExcel/UploadExcel/class" method="post" enctype="multipart/form-data">
							<div class="col-lg-3">
							...
							<div class="col-lg-9">
								...
								<a href="<?php echo site_url() ?>/C_ImportExcel/DownloadForm/class" class="btn btn-default">Download Format</a>
							</div>
							</form>
						</div>
					</div>
			...
			<?php endif; ?>
				<div class="col-lg-8">
					<form class="form-group" method="post" action="<?php echo site_url() ?>/C_CUD/aksiTambah/class" enctype="multipart/form-data">
						<div class="row form">
							<div class="col-lg-2">
								<h5>Gambar</h5>
							</div>
						...
						<div class="row form">
							...
							<div class="col-lg-9">
								<textarea rows="6" name="keterangan" class="form-control " maxlength="500" placeholder="" required></textarea>
							</div>
						</div>
						<div class="row form">
							<div class="col-lg-12">
